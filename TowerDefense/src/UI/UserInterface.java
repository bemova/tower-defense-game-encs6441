...
public class UserInterface extends JFrame {
	...
	TowerWindowOnMap towerPropertyPanel = new TowerWindowOnMap(this);
	...
	UserInterface() {
			  ...
			  public void actionPerformed(ActionEvent e)
			  {
			    try
			    {
		               ...
		               if(JFileChooser.APPROVE_OPTION  == openFile.showOpenDialog(null)){
		                grid = new CompleteGrid(grid);
		               grid.gridAssignmentOperator( mapManager.LoadMapFromFile(openFile.getSelectedFile().getAbsolutePath()));
		               canva.updateGrid(grid);
		                width = grid.getWidth();
		...
		save.addActionListener( new java.awt.event.ActionListener() {
			  public void actionPerformed(ActionEvent e)
			  {
	            ...
	            if(!errorMessage.equals(""))	JOptionPane.showMessageDialog(null, errorMessage);
		  ...
		  canva.addMouseListener(new MouseAdapter() {
			     ...
			     public void mousePressed(MouseEvent e) {
			    	 if(designMap.isEnabled()){
				      ...
				      if((i < grid.getHeight()) && (j < grid.getWidth()) && (grid.content[i][j] != colorInInteger)){
					    ...
					    /*	 towerParam = ((Map)grid).towers.get(position).parameters;
					    	 ...
					    	 String view = "<html>\n" +
					                 "Tower characteristics:\n" +
					                 "<ul>\n" +
					                 "<li><font color=red>Distance: " + price + "</font>\n" +
					                 "<li><font color=blue>Frequency:" + towerParam.firingSpeed +"</font>\n" +
					                 "<li><font color=green>Power: x</font>\n" +
					                 "<li><font color=green>Damage: 3</font>\n" +
					                 "</ul>\n";
