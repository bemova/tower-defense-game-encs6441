...
/**
 * this calss used as a service to chech some validation in map based on the
...
public class StartEndChecker implements IStartEndChecker {
	/**
	 * <b>it can used for check any two positions that were selected have
	 * overlap with others our not</b>
	 * 
	 * @param first
	 * @param second
	 * @return boolean
	...
	/**
	 * <b>it can check if the node that was selected is located on the age of
	 * grid or not</b>
	 * 
	 * @param width
	 * @param height
	 ...
	 * @return
	 */
	public boolean nodeChecker(GridCellContentType[][] matrix,
			GridCellContentType expected) {
		boolean flag = false;
		try {
